...
<head>
    ...
    <?php $doc->setGenerator( '' ); ?>
   
   <link href="<?php echo $this->baseurl ?>/components/com_sppagebuilder/assets/css/animate.min.css" rel="stylesheet" type="text/css" />
    <?php

    $this->helix3->addCSS('bootstrap.min.css, font-awesome.min.css') // CSS Files
        ->addJS('bootstrap.min.js, jquery.sticky.js, main.js, sppagebuilder.js') // JS Files
...
<body class="<?php echo $this->helix3->bodyClass( $body_classes ); ?> <?php echo $this->params->get('header_color'); ?> <?php echo $this->params->get('header_opacity'); ?>" >
