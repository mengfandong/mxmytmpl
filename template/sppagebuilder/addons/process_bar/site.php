...
AddonParser::addAddon('sp_process_bar','sp_process_bar_addon');

function sp_process_bar_addon($atts){
	...
	extract(spAddonAtts(array(
		...
		$style_hover = '.feature-boxed-'. $uniqueid .':hover .sppb-addon-content {';
		...
		$style_icon_hover    = '.feature-boxed-'. $uniqueid .':hover  .sppb-icon span {';
		...
		$arrow_color_hover 	 = '.feature-boxed-'. $uniqueid .':hover .sppb-addon-content.right_arrow_yes:after {';
		$arrow_color_hover	.= 'color:'. $box_border_color_hover .' !important;';
		$arrow_color_hover	.= '}';
		
		$title_color_hover 	 = '.feature-boxed-'. $uniqueid .':hover .sppb-addon-content .sppb-feature-box-title {';
		$title_color_hover	.= 'color:'. $title_text_hover_color .' !important;';
		$title_color_hover	.= '}';
		
		$process_bar_before 	 = '.feature-boxed-'. $uniqueid .' .process_bar:before, .feature-boxed-'. $uniqueid .' .process_bar:after {';
		$process_bar_before	.= 'background:'. $process_bar_color .' !important;';
		$process_bar_before	.= '}';
		
		$process_bar_hover 	 = '.feature-boxed-'. $uniqueid .':hover .process_bar, .feature-boxed-'. $uniqueid .':hover .process_bar, .feature-boxed-'. $uniqueid .':hover .process_bar:before, .feature-boxed-'. $uniqueid .':hover .process_bar:after  {';
		$process_bar_hover	.= 'background:'. $process_bar_hover_color .' !important;';
		$process_bar_hover	.= '}';
		...
		$doc->addStyleDeclaration($process_bar_before);
		$doc->addStyleDeclaration($process_bar_hover);
	...
	if($title_position == 'up') {
		$icon_image_position = 'up';
	} else if($title_position == 'down') {
		$icon_image_position = 'down';
	} else {
	...
	$process_bar_style = '';
	if($process_bar_height) $process_bar_style .= 'height:'. $process_bar_height . ';';
	if($process_bar_color) $process_bar_style .= 'background:'. $process_bar_color . ';';
	...
	if($title) {
		...
		$feature_title .= '<'.$heading_selector.' class="sppb-feature-box-title" style="' . $title_style . '">' . $title . '</'.$heading_selector.'>';
	...
	//Output
	$output  = '<div class="sppb-addon sppb-addon-process-bar  ' . $class . ' feature-boxed-'. $uniqueid .' process-bar-'. $title_position .'">';
	

	if ($icon_image_position == 'up') {

		if($media) $output .= $media;
		$output .= '<div class="process_bar '. $process_bar_fl .'" style="' . $process_bar_style . '"></div>';
		$output .= '<div class="sppb-addon-content ' . $alignment . ' '. $right_arrow .'" style="'. $box_style .' ">';
		if($title) $output .= $feature_title;

		$output .= $feature_text;
		$output .= '</div>';

	} else if ($icon_image_position == 'down') {
		$output .= '<div class="sppb-addon-content ' . $alignment . ' '. $right_arrow .'" style="'. $box_style .'">';
		if($title) $output .= $feature_title;
		$output .= $feature_text;
		$output .= '</div>';
	...
	} else if ($icon_image_position == 'up') {
		$output .= '<div class="sppb-addon-content ' . $alignment . ' '. $right_arrow .'" style="'. $box_style .'">';
		if($title) $output .= $feature_title;
	...
	//Output
	$output  = '<div class="sppb-addon sppb-addon-process-bar  ' . $class . ' feature-boxed-'. $uniqueid .' faa-parent animated-hover process-bar-'. $title_position .'">';
