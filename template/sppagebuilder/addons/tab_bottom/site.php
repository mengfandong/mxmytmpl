...
AddonParser::addAddon('sp_tab_bottom','sp_tab_bottom_addon');
AddonParser::addAddon('sp_tab_bottom_item','sp_tab_bottom_item_addon');

$sppbTabArray = array();
function sp_tab_bottom_addon($atts, $content){
	global $sppbTabArray;
	...
	$output .= '<div class="sppb-addon-content sppb-tab sppb-tab-' . $style . '">';
...
function sp_tab_bottom_item_addon( $atts ){
	global $sppbTabArray;
