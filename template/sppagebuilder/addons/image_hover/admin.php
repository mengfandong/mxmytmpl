...
SpAddonsConfig::addonConfig(
	array( 
		'type'=>'repeatable', 
		'addon_name'=>'sp_image_hover',
		'category'=>'General',
		'title'=>JText::_('Partners'),
		'desc'=>JText::_('Amazing Parnters Logo'),
		'attr'=>array(
			'admin_label'=>array(
				'type'=>'text', 
			...
			'repetable_item'=>array(
				'type'=>'repeatable',
				'addon_name' =>'sp_image_hover_item',
				'title'=>'Repetable', 
				'attr'=>array(
					...
					'text'=>array(
						'type'=>'editor', 
						'title'=>JText::_('Text'),
						'std'=>'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam cursus placerat leo sit amet elementum. Mauris a dolor dui. Nulla ullamcorper purus vel aliquam tristique.'
						),
