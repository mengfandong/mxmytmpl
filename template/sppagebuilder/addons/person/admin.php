...
SpAddonsConfig::addonConfig(
	array( 
		...
		'attr'=>array(
			...
			'border_color'=>array(
				'type'=>'color', 
				'title'=>JText::_('Image border Color'),
				'desc'=>JText::_('Select Image Border Color'),
				),	
			'border_width'=>array(
				'type'=>'number', 
				'title'=>JText::_('Image border Width'),
				'desc'=>JText::_('Select Image Border Width'),
				),	
				
			'image_radius'=>array(
				'type'=>'text', 
				'title'=>JText::_('Image border Radius'),
				'desc'=>JText::_('Select Image Border Radius'),
				),
			
			'image_margin'=>array(
				'type'=>'text', 
				'title'=>JText::_('Image Margin'),
				'desc'=>JText::_('Select Image Margin'),
				'placeholder'=>'10px 10px 10px 10px',
				),
			
			'image_animation'=>array(
				'type'=>'select',
				'title'=>JText::_('Image Animation on Hover'),
				'desc'=>JText::_('Select Yes If want animation on hover of Image'),
				'values'=>array(
					''=>JText::_('No'),
					'animated_yes'=>JText::_('Yes'),
					),
				'std'=>'',
				),
			...
			'name_color'=>array(
				...
				'desc'=>JText::_('Select Persons Name Color'),
				),	
				
			'name_bg_color'=>array(
				'type'=>'color',
				'title'=>JText::_('Name Background Color'),
				'desc'=>JText::_('Select Persons Name Background Color'),
				),	
			'name_margin'=>array(
				'type'=>'text',
				'title'=>JText::_('Name Margin'),
				'desc'=>JText::_('Select Persons Name Margin'),
				'placeholder'=>'10px 10px 10px 10px',
				),	
