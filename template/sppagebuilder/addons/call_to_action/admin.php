	...
	array( 
		...
		'attr'=>array(
			...
			'text_transform'=>array(
				...
				'desc'=>JText::_('Select Text Transform of Title'),
				'values'=>array(
					'none'=>JText::_('None'),
			...
			'hover_border'=>array(
				'type'=>'select', 
				'title'=>JText::_('Hover Border Effect'),
				'desc'=>JText::_('Select Hover Border Effect Yes or No'),
				'values'=>array(
					'hover_border_yes'=>JText::_('Yes'),
					'hover_border_no'=>JText::_('No'),
					),
				),
			'padding'=>array(
				'type'=>'text',
			...
			'button_icon'=>array(
				'type'=>'icon', 
				'title'=>JText::_('Button 1 Icon'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_BUTTON_ICON_DESC'),
				),
				
			'button_target'=>array(
				'type'=>'select', 
				'title'=>JText::_('Button 1 Target'),
			...
			'button2_text'=>array(
				'type'=>'text', 
				'title'=>JText::_('Button 2 Text'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_BUTTON_TEXT_DESC'),
				'placeholder'=>'Button Text',
				),
			'button2_url'=>array(
				'type'=>'text', 
				'title'=>JText::_('Button 2 URL'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_BUTTON_URL_DESC'),
				'placeholder'=>'http://'
				),
			...
			'button2_icon'=>array(
				'type'=>'icon', 
				'title'=>JText::_('Button 2 Icon'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_BUTTON_ICON_DESC'),
				),
			
			'button2_target'=>array(
				'type'=>'select', 
				'title'=>JText::_('Button 2 Target'),
				'desc'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_TARGET_DESC'),
				'values'=>array(
					''=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_TARGET_SAME_WINDOW'),
					'_blank'=>JText::_('COM_SPPAGEBUILDER_ADDON_GLOBAL_TARGET_NEW_WINDOW'),
