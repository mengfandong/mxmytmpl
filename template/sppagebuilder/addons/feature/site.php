...
function sp_feature_addon($atts){
	...
	extract(spAddonAtts(array(
		...
		"icon_position"			=> 'iconwithtitle_no',
		"feature_type"			=> 'icon',
		"feature_image"			=> '',
		'icon_name' 			=> '',
		'icon_color' 			=> '',
	...
	$icon_with_title = '';
	if($icon_position == 'iconwithtitle_yes') $icon_with_title .= 'style="float:left; margin-right:15px;"';
	...
	if($icon_animation_style == 'animated'){
		if($feature_type == 'icon') {
			if($icon_name) {
				...
				$media  .= '<div class="sppb-icon" '. $icon_with_title .'>';
			...
			if($feature_image) { 
				...
				if($icon_margin_left) $img_style .= 'margin-left:' . (int) $icon_margin_left . 'px;';
	...
	if($title) {
		...
		if($title_bottom_margin) $title_style .= 'margin-bottom:'.$title_bottom_margin.'px;';
		if($title_top_margin) $title_style .= 'margin-top:'.$title_top_margin.'px;';
	...
	//Output
	$output  = '<div class="sppb-addon sppb-addon-feature ' . $alignment . ' ' . $class . '">';
	$output .= '<div class="sppb-addon-content faa-parent animated-hover">';
