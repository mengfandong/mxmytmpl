...
<div class="itemBody">
	  ...
	  <div class="itemImageBlock">
		  <span class="itemImage">
		  	<a href="<?php echo $this->item->imageXLarge; ?>" title="<?php echo JText::_('K2_CLICK_TO_PREVIEW_IMAGE'); ?>"></a>
	...
	<div class="itemHeader">
	  ...
	  <?php if($this->item->params->get('itemCategory') || $this->item->params->get('itemAuthor') || $this->item->params->get('itemTags') || $this->item->params->get('itemAttachments') || $this->item->params->get('itemDateCreated')): ?>
	  <div class="itemLinks">
	  		...
	  		<div class="itemLinksLeft">
				...
				<div class="itemCategory">
					<span><?php //echo JText::_('K2_PUBLISHED_IN'); ?><i style="display: inline-block; margin-right: 5px;" class="icon-file-text-alt"></i> </span>
				...
				<?php if($this->item->params->get('itemDateCreated')): ?>
					<div class="itemBlogDate">
						<span class="item_date_text"><?php //echo JText::_('K2_PUBLISHED_IN'); ?><i style="display: inline-block; margin-right: 5px;" class="icon-time"></i> </span>
						<span class="sp_date_day"><?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_LC3')); ?></span>
					</div>
			...
			<!-- Print Button -->
				<a class="itemPrintLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
					<span><?php //echo JText::_('K2_PRINT'); ?> <i style="margin-right: 5px;" class="icon-print"></i></span>
				</a>
			<?php endif; ?>
			...
			<!-- Email Button -->
				<a class="itemEmailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
					<span><?php //echo JText::_('K2_EMAIL'); ?><i style="margin-right: 5px;" class="icon-envelope-alt"></i></span>
				</a>
			<?php endif; ?>
		  ...
		  <div class="itemTagsBlock">
			  <span class="itemAuthorTagText"> <?php echo JText::_('TAG: '); ?> </span>
			  <ul class="itemTags">
 ...
 <div class="clr"></div>
	  ...
	  <!-- Item text -->
	  <div class="itemFullText">
	  	<?php echo $this->item->introtext; ?>000
	  </div>
	  <?php endif; ?>
	  ...
	  <div class="itemVideoBlock">
	  	<h3 class="k2IModuleTitle"><?php echo JText::_('K2_MEDIA'); ?></h3>
  ...
  <div class="itemAuthorBlock">
    ...
    <div class="itemAuthorDetails">
  	...
  	<?php
  	 if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
     ...
     <div class="authorInfoWrapper">
     	<?php //print_r($this->item->author->); die;?>
  ...
  <!-- Related items by tag -->
	<div class="itemRelated">
		<h3 class="k2IModuleTitle"><?php echo JText::_("K2_RELATED_ITEMS_BY_TAG"); ?></h3>
		<ul>
			<?php
			//Count related items
			$related_item_count= count($this->relatedItems);
			// Repeat related items
			foreach($this->relatedItems as $key=>$item): ?>
			<li class="<?php echo ($key%2) ? "odd" : "even"; echo " span". 12/$related_item_count; ?>">
	    ...
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?>">
	    	...
	    	<span class="commentLink">
				...
				<div class="commentImageWrapper">
					<div class="commentImageBlock">
						<span>
							<a href="<?php echo $comment->commentURL; ?>">
