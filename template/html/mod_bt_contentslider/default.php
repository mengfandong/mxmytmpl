	...
	<?php foreach( $pages as $key => $list ): ?>
		...
		<?php foreach( $list as $i => $row ): ?>
			<div class="bt-row <?php if($i==0) echo 'bt-row-first'; else if($i==count($list)-1) echo 'bt-row-last' ?>"  style="width:<?php echo $itemWidth;?>%" >
				<div class="bt-inner"><div class="bt-content_holder">
				...
				<?php endif ; ?>
                    ...
                    <?php if( $showDate ): ?>
						...
						<span class="bt-date"><?php echo $row->date; ?>
						</span>
                    ...
                    <div class="bt-content-inner hvr-sweep-to-top">
					...
					<?php if($show_category_name_as_link) : ?>Category: 
					...
					<?php else :?>
					<div class="bt-category">Category: <?php echo $row->category_title; ?> </div>
					<?php endif; ?>
					<?php endif; ?>
